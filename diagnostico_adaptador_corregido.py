"""
Script de diagnóstico mejorado para verificar si MotoAdapter funciona correctamente.
...
def main():
    ...
    try:
        ...
        # Clave: asegurarnos de que el DataFrame de ratings tiene la estructura correcta
        ratings = [{'user_id': 'test_user', 'moto_id': 'test_moto', 'rating': 4.5}]
