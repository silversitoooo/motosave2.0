...
try:
    ...
    print(f"  OK - Usuarios creados: {len(users_df)}")
    ...
    print(f"  OK - Motos creadas: {len(motos_df)}")
    ...
    print(f"  OK - Valoraciones creadas: {len(ratings_df)}\n")
    
    # Probar el adaptador
    print("* Creando adaptador del recomendador...")
    adapter = MotoRecommenderAdapter()
    print("  OK - Adaptador creado correctamente")
    ...
    print(f"  OK - Se generaron {len(recs_user1)} recomendaciones")
    ...
    print(f"  OK - Se generaron {len(recs_user2)} recomendaciones")
    ...
    print(f"  {str(e)}")
    traceback.print_exc()
    print("\nEl diagnostico no se completo correctamente.")
