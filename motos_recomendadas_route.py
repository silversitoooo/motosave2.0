...
logger = logging.getLogger('update_routes')

# Importar la función de recomendaciones 
sys.path.append(os.path.dirname(os.path.abspath(__file__)))
from recomendaciones import get_label_propagation_recommendations

# Aplicar las rutas actualizadas directamente en el blueprint de routes_fixed.py
def register_motos_recomendadas_route(fixed_routes):
    """
    Registra la ruta de motos recomendadas en el blueprint proporcionado
    """
    # Importar el decorador login_required
    ...
    def motos_recomendadas():
        ...
        """
        logger.info("Accediendo a la página de motos recomendadas")
        ...
        try:
            ...
            if adapter and hasattr(adapter, '_ensure_neo4j_connection'):
                ...
                with adapter.driver.session() as db_session:
                    ...
                    logger.info(f"Generadas {len(propagation_motos)} recomendaciones para usuario {user_id}")
